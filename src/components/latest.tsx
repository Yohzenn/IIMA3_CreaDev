        ...
        <div className="flex flex-col md:flex-row items-center gap-8 overflow-hidden">
          ...
          <div className="flex flex-col flex-1 w-full gap-6">
            ...
            <div className="flex items-center justify-center gap-8">
              ...
              <button
                onClick={togglePlay}
                className="w-16 h-16 rounded-full! border-none! bg-linear-to-br from-pink-dark to-pink-light flex items-center justify-center hover:scale-105 transition-transform shadow-lg shadow-pink-dark/50"
              >
                {isPlaying ? (
                  <svg
                    width="24"
